  ...
  return (
    <div className="container-contact">
      <div className="container-title-contact">
        ...
        <span className="phrase-contact">Envíame un mensaje.</span>
      </div>
      <div className="container-whatsapp-linkedin">
        <div>
          <a
            className="social-contact"
            href="https://wa.me/573104256562?text=Hola,%20como%20estas?"
            target="_blank"
            rel="noreferrer"
          >
            <svg
        ...
        <div>
          <a
            className="social-contact"
            href="https://www.linkedin.com/in/mateo-r%C3%ADos-diaz-16458b186/"
            target="_blank"
            rel="noreferrer"
          >
            <svg
